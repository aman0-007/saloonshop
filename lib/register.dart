                        ...
                        children: [
                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  hintText: 'Shop Name',
                                  hintStyle: TextStyle(color: Colors.blueAccent.withOpacity(0.5)), // Set hint text color to white
                                  ...
                                  labelStyle: TextStyle(color: Colors.white), // Set entered text color to white
                                ),
                                style: TextStyle(color: Colors.white), // Set overall text color to white
                                onTap: () {
                                  setState(() {
                          ...
                          ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              ...
                              minimumSize: Size(deviceWidth * 0.55, 0), // Set width to 60% of device width
                            ),
                            child: Text(
                              'Register',
